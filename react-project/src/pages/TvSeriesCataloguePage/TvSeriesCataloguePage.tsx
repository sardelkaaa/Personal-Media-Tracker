...
export function TvSeriesCataloguePage() {
  const { data: tvSeries = [], isLoading, isError } = useTvSeries();
  ...
  return (
    <Container>
      ...
      <AddMediaFormModal opened={addOpened} onClose={addCtrl.close} type="tvseries" />
      ...
      <MediaGrid items={filtered} onSelect={(tvSeries) => { setSelectedMovie(tvSeries); modalCtrl.open(); }} />
